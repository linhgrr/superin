"""Habit plugin business logic — NO FastAPI imports here."""

from typing import Optional

from .repository import habit_service, HabitRepository
...
def _habit_to_dict(d: Habit) -> dict:
